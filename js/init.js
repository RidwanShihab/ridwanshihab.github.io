! function(o) {
    ...
    var e = {
        root: o(":root"),
        init: function() {
            e.BgImg(), e.imgToSVG(), e.rightPanelScroll(), e.rightNav(), e.tabs(), e.progress(), e.cursor(), e.portfolioCarousel(), e.testimonialCarousel(), e.loadBlogPosts(), e.movingPlaceholder(),e.scrollToAnchor(), e.pageWidthAnimation(), e.modal(), e.typed()
        },
        typed: function() {
